# Code for creating a two Phase locking scheduler for a database 
import re
import sys

# This class defines the various functions performed by the transaction
class Operation():
...
def record_is_visible(self, record):
        return record['expired_xid'] == 0
#Class used to implement Locking
class Lock():
...
# Two Phase lock Scheduler class for executing the Transactions
class Scheduler():
...
if __name__ == '__main__':
    ...
    scheduler.execute('r1[z] r2[y] r1[y] c1 w2[x] c2')
